...
private:
    ...
    vector<string> cities; /** A vector of strings containing the names of existing cities */
    unordered_map<string, unordered_map<string, float>> distances; /** A 2D map representing distances between cities. */
