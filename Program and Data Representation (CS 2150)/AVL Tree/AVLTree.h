//Kyle Cheng, kwc9ap, 10/9/20, AVLTree.h
#ifndef AVL_H
#define AVL_H
...
private:
	...
	//recursive helper pathTo
    string pathTo(const AVLNode* tree, const string& x) const ;
    
    bool find(const AVLNode* tree, const string& x) const;
